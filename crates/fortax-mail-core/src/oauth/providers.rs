...
pub const GOOGLE: OAuthProviderConfig = OAuthProviderConfig {
    ...
    client_id_env: "FORTAX_GOOGLE_DESKTOP_CLIENT_ID",
    client_secret_env: "FORTAX_GOOGLE_DESKTOP_CLIENT_SECRET",
};
...
pub const MICROSOFT: OAuthProviderConfig = OAuthProviderConfig {
    ...
    client_id_env: "FORTAX_MICROSOFT_DESKTOP_CLIENT_ID",
...
fn bundled_credentials(provider: Provider) -> Option<(String, Option<String>)> {
    ...
    let (client_id, client_secret) = match provider {
        Provider::Gmail => (option_env!("FORTAX_GOOGLE_ANDROID_CLIENT_ID"), None),
        Provider::Microsoft => (option_env!("FORTAX_MICROSOFT_ANDROID_CLIENT_ID"), None),
        Provider::Imap => return None,
    };
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    let (client_id, client_secret) = match provider {
        Provider::Gmail => (
            option_env!("FORTAX_GOOGLE_DESKTOP_CLIENT_ID"),
            option_env!("FORTAX_GOOGLE_DESKTOP_CLIENT_SECRET"),
        ),
        Provider::Microsoft => (option_env!("FORTAX_MICROSOFT_DESKTOP_CLIENT_ID"), None),
        Provider::Imap => return None,
    };
...
/// the application, followed by the documented Fortax Mail runtime variables.
pub fn resolve_credentials(provider: Provider) -> Result<(String, Option<String>)> {
    ...
    let (client_id_env, client_secret_env) = match provider {
        Provider::Gmail => (
            "FORTAX_MAIL_GOOGLE_CLIENT_ID",
            Some("FORTAX_MAIL_GOOGLE_CLIENT_SECRET"),
        ),
        Provider::Microsoft => ("FORTAX_MAIL_MS_CLIENT_ID", None),
        Provider::Imap => {
...
fn bundled_client_id_env(provider: Provider) -> &'static str {
    ...
    return match provider {
        Provider::Gmail => "FORTAX_GOOGLE_ANDROID_CLIENT_ID",
        Provider::Microsoft => "FORTAX_MICROSOFT_ANDROID_CLIENT_ID",
        Provider::Imap => "",
    };
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    match provider {
